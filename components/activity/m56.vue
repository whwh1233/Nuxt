...
<template>
  <div class="m5666">
    <!-- <div class="m56__tpldata">{{ tplData }}</div> -->

    <div class="m56-swiper-container" :style="{ backgroundImage: 'url(' + tplData.bgImg + ')' }">
      <!-- :style="{ width: width, height: '300px' }" -->
      <div class="swiper-wrapper-box" :id="'s' + tplData.connId" :style="{ width: '400px', height: '300px' }" :self-data="selfData" data-emergence="hidden" prefix="m56">
        <div class="swiper-wrapper">
          <div>
            <img :src="bannerList[0].pic" alt="" />
          </div>
